...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:8080", "http://localhost:8080", "https://api.hotketok.store", "http://localhost:5173","http://localhost:5174","https://api.hotketokweb.shop")); // 허용할 Origin
